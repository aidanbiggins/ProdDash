/**
 * PipelineChart V2 - Tailwind Implementation
...
interface PipelineChartV2Props {
...
export function PipelineChartV2({ stages }: PipelineChartV2Props) {
                  ...
                  <div className="flex-1 flex items-center gap-3">
                    ...
                    {index < stages.length - 1 && (
                      <div className={cn(
                        ...
                        isLowConversion ? 'text-warn' : 'text-muted-foreground'
                      )}>
                        <ArrowRightIcon />
...
export default PipelineChartV2;
