...
interface VelocityCopilotPanelV2Props {
  ...
  /** Callback when copilot insights change - allows parent to access P0/P1/P2 insights */
  onInsightsChange?: (insights: AICopilotInsight[]) => void;
}
...
export function VelocityCopilotPanelV2({
  ...
  // Notify parent when insights change (for Decision Brief)
  useEffect(() => {
  ...
  return (
    <div className="glass-panel p-3 mb-4" data-testid="velocity-copilot-panel">
      ...
      {/* Loading state - simple spinner, no dodecahedron */}
      {isLoading && (
        <div className="flex items-center justify-center gap-2 py-4 text-muted-foreground text-sm">
          <span className="w-4 h-4 border-2 border-current border-r-transparent rounded-full animate-spin" />
          <span>Analyzing...</span>
...
// Re-export AICopilotInsight type for parent components (Decision Brief)
export type { AICopilotInsight } from '../../../types/velocityCopilotTypes';
