  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85">
      <div className="w-full max-w-5xl mx-4 flex flex-col max-h-[90vh]">
        <div className="bg-card border border-border rounded-lg shadow-xl flex flex-col overflow-hidden">
          ...
          <div className="flex justify-end gap-2 p-4 border-t border-border">
            <button className="px-4 py-2 text-sm font-medium rounded-md border border-border text-muted-foreground hover:text-foreground hover:bg-muted" onClick={onClose}>Close</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Job: System ID, Job: Requisition ID</td><td className="px-3 py-2"><code className="text-accent">req_id</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Job: Job Title and Job Code</td><td className="px-3 py-2"><code className="text-accent">req_title</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Job: Date Opened, Posted Date</td><td className="px-3 py-2"><code className="text-accent">opened_at</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Job: Status</td><td className="px-3 py-2"><code className="text-accent">status</code></td><td className="px-3 py-2 text-muted-foreground">"Open", "Closed", etc.</td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Recruiter Full Name, Primary Recruiter</td><td className="px-3 py-2"><code className="text-accent">recruiter_id</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Hiring Manager Full Name</td><td className="px-3 py-2"><code className="text-accent">hiring_manager_id</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Person: System ID</td><td className="px-3 py-2"><code className="text-accent">candidate_id</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Submittal Date, Application Date</td><td className="px-3 py-2"><code className="text-accent">applied_at</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Workflow Status, Current Status</td><td className="px-3 py-2"><code className="text-accent">current_stage</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Last Updated Date, Status Date</td><td className="px-3 py-2"><code className="text-accent">current_stage_entered_at</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Source</td><td className="px-3 py-2"><code className="text-accent">source</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Hire/Rehire Date</td><td className="px-3 py-2"><code className="text-accent">hired_at</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Date First Interviewed: Offer Letter</td><td className="px-3 py-2"><code className="text-accent">offer_extended_at</code></td><td className="px-3 py-2 text-muted-foreground"></td></tr>
          </tbody>
        </table>
      </div>
    ...
    <div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Job ID, Requisition ID</td><td className="px-3 py-2"><code className="text-accent">req_id</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Job Name, Job Title</td><td className="px-3 py-2"><code className="text-accent">req_title</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Opening Date, Job Created</td><td className="px-3 py-2"><code className="text-accent">opened_at</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Closed Date, Date Closed</td><td className="px-3 py-2"><code className="text-accent">closed_at</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Recruiter</td><td className="px-3 py-2"><code className="text-accent">recruiter_id</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Hiring Manager, Hiring Lead</td><td className="px-3 py-2"><code className="text-accent">hiring_manager_id</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Candidate ID, Application ID</td><td className="px-3 py-2"><code className="text-accent">candidate_id</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Applied On, Application Date</td><td className="px-3 py-2"><code className="text-accent">applied_at</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Current Stage, Stage</td><td className="px-3 py-2"><code className="text-accent">current_stage</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Source, Source Name</td><td className="px-3 py-2"><code className="text-accent">source</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Start Date</td><td className="px-3 py-2"><code className="text-accent">hired_at</code></td></tr>
          </tbody>
        </table>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Posting ID, Requisition ID</td><td className="px-3 py-2"><code className="text-accent">req_id</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Posting Title</td><td className="px-3 py-2"><code className="text-accent">req_title</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Posting Created At</td><td className="px-3 py-2"><code className="text-accent">opened_at</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Posting State</td><td className="px-3 py-2"><code className="text-accent">status</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Owner</td><td className="px-3 py-2"><code className="text-accent">recruiter_id</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Hiring Manager</td><td className="px-3 py-2"><code className="text-accent">hiring_manager_id</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Opportunity ID, Candidate ID</td><td className="px-3 py-2"><code className="text-accent">candidate_id</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Created At (opportunity)</td><td className="px-3 py-2"><code className="text-accent">applied_at</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Stage</td><td className="px-3 py-2"><code className="text-accent">current_stage</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Stage Changed At</td><td className="px-3 py-2"><code className="text-accent">current_stage_entered_at</code></td></tr>
            <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">Origin, Source</td><td className="px-3 py-2"><code className="text-accent">source</code></td></tr>
          </tbody>
        </table>
      </div>
    </div>
      ...
      <div className="glass-panel p-4 mb-4">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">job_id, req_id, requisition_id</td><td className="px-3 py-2 text-muted-foreground">REQ-2024-001</td><td className="px-3 py-2 text-bad font-medium">Yes</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">job_title, title</td><td className="px-3 py-2 text-muted-foreground">Senior Engineer</td><td className="px-3 py-2 text-foreground">Recommended</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">open_date, opened_at, created_date</td><td className="px-3 py-2 text-muted-foreground">2024-01-15</td><td className="px-3 py-2 text-bad font-medium">Yes</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">status, job_status</td><td className="px-3 py-2 text-muted-foreground">Open</td><td className="px-3 py-2 text-foreground">Recommended</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">close_date, closed_at, filled_date</td><td className="px-3 py-2 text-muted-foreground">2024-03-01</td><td className="px-3 py-2 text-foreground">For TTF</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">recruiter, recruiter_name</td><td className="px-3 py-2 text-muted-foreground">Jane Smith</td><td className="px-3 py-2 text-foreground">Recommended</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">hiring_manager, hm</td><td className="px-3 py-2 text-muted-foreground">Bob Johnson</td><td className="px-3 py-2 text-foreground">For HM metrics</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">candidate_id, person_id, applicant_id</td><td className="px-3 py-2 text-muted-foreground">CAND-12345</td><td className="px-3 py-2 text-bad font-medium">Yes</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">candidate_name, name</td><td className="px-3 py-2 text-muted-foreground">Alice Williams</td><td className="px-3 py-2 text-foreground">Optional</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">applied_at, application_date</td><td className="px-3 py-2 text-muted-foreground">2024-01-20</td><td className="px-3 py-2 text-foreground">Recommended</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">current_stage, stage, status</td><td className="px-3 py-2 text-muted-foreground">Onsite Interview</td><td className="px-3 py-2 text-foreground">Recommended</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">stage_date, stage_entered_at</td><td className="px-3 py-2 text-muted-foreground">2024-02-10</td><td className="px-3 py-2 text-foreground">For velocity</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">source</td><td className="px-3 py-2 text-muted-foreground">LinkedIn, Referral</td><td className="px-3 py-2 text-foreground">For source analysis</td></tr>
              <tr className="border-b border-border"><td className="px-3 py-2 text-foreground">hired_at, hire_date, start_date</td><td className="px-3 py-2 text-muted-foreground">2024-03-15</td><td className="px-3 py-2 text-foreground">For TTF/offers</td></tr>
            </tbody>
          </table>
        </div>
      </div>
